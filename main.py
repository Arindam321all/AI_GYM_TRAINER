...
def main():
    ...
    print(f"🔑 API Key: {os.environ.get('GROQ_API_KEY', 'NOT FOUND')}")
    print(f"🤖 Voice pipeline: {st.session_state.voice_pipeline}")
    ...
    if st.session_state.get("audio_to_play"):
        autoplay_audio(st.session_state.audio_to_play)
        st.session_state.audio_to_play = None  # ← ADD THIS LINE
